...
<body class="bg-gray-50 text-gray-800">
  ...
  <section class="max-w-6xl mx-auto px-4 py-20 text-center">
    <h2 class="text-4xl font-extrabold mb-4">
      Manage Tasks Easily with Role-Based Access
    </h2>
    <p class="text-gray-600 text-lg max-w-2xl mx-auto mb-8">
      A simple task management system where Superadmins manage Admins, Admins manage Members, 
      and Members complete assigned tasks. Fast, organized, and efficient.
    </p>
  ...
  <section class="bg-white py-16">
    <div class="max-w-6xl mx-auto px-4">
      <h3 class="text-3xl font-bold text-center mb-12">User Roles</h3>

      <div class="grid sm:grid-cols-1 md:grid-cols-3 gap-8">

        <!-- Superadmin -->
        <div class="bg-gray-100 p-6 rounded-xl shadow hover:shadow-lg transition">
          <h4 class="text-xl font-bold mb-3">Superadmin</h4>
          <ul class="space-y-2 text-gray-700">
            <li>• Manage Admin Accounts</li>
            <li>• View Members</li>
            <li>• (Optional) View All Tasks</li>
          </ul>
        </div>

        <!-- Admin -->
        <div class="bg-gray-100 p-6 rounded-xl shadow hover:shadow-lg transition">
          <h4 class="text-xl font-bold mb-3">Admin</h4>
          <ul class="space-y-2 text-gray-700">
        ...
        <!-- Member -->
        <div class="bg-gray-100 p-6 rounded-xl shadow hover:shadow-lg transition">
          <h4 class="text-xl font-bold mb-3">Member</h4>
          <ul class="space-y-2 text-gray-700">
  ...
  <section class="max-w-6xl mx-auto px-4 py-16">
    ...
    <div class="grid md:grid-cols-2 gap-8">
      ...
      <div class="bg-white p-6 shadow rounded-xl border">
        <h4 class="text-xl font-bold mb-2">Task Assignment</h4>
        <p class="text-gray-600">Admins can assign tasks directly to members with deadlines.</p>
      </div>

      <div class="bg-white p-6 shadow rounded-xl border">
        <h4 class="text-xl font-bold mb-2">Role-Based Access</h4>
        <p class="text-gray-600">Each user only sees features relevant to their role.</p>
      </div>

      <div class="bg-white p-6 shadow rounded-xl border">
        <h4 class="text-xl font-bold mb-2">Progress Tracking</h4>
        <p class="text-gray-600">Admins can instantly view progress on all member tasks.</p>
      </div>

      <div class="bg-white p-6 shadow rounded-xl border">
        <h4 class="text-xl font-bold mb-2">Simple UI</h4>
        <p class="text-gray-600">Minimal, clean, and built for efficiency.</p>
      </div>
